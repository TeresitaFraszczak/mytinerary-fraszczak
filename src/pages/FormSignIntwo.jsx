...
export default function Form() {
  ...
  return (
    <div className="flex flex-row m-12">
       ...
       <input ref={password_signin}  type="password"  className="block min-h-[auto] w-full p-3" name="password" id="password"  defaultValue="" placeholder="Password"  />
       ...
       <button className='m-2 px-10 py-0 flex w-2/4 rounded bg-[#4F46E5] hover:bg-orange-600 shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out'> 
          <Anchor to={ '/auth/singintwo'} className="font-medium px-0 py-1 text-white">SIGN IN!</Anchor>
          </button> 
