...
export default function Form() {
  ...
  return (
    ...
    <button type="button" data-te-ripple-init  data-te-ripple-color="light" className="m-3 h-9 w-9 rounded-full bg-primary uppercase     leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow- [0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] ">
     ...
     <button type="button" data-te-ripple-init data-te-ripple-color="light" className="m-3 h-9 w-9 rounded-full bg-primary uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)]">
        <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-3.5 w-3.5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <input ref={password} type="password" className="block min-h-[auto] w-full p-3" name="password" id="password" defaultValue="" placeholder="Password"/>
       ...
       <Anchor to={ '/auth/signuptwo'} className="text-white font-medium px-0 py-1">Continue</Anchor>
       </button> 
       </div>
       </main>
   ) : ( 
       ...
       <p className="flex text-[12px]">New user?{" "}
           <Anchor
             ...
             to='/pages/formsignup'>Create an account
           </Anchor>
       </p>
         
       
       <input ref={mailsignin}  type="text"  className="block min-h-[auto] w-full p-3" name="mail" id="mail"  defaultValue="" placeholder="Mail"  />
       
       <button className='m-2 px-10 py-0 flex w-2/4 rounded bg-[#4F46E5] hover:bg-orange-600 shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out'> 
          <Anchor to={ '/auth/signintwo'} className="text-white font-medium px-0 py-1">Continue</Anchor>
          </button> 
