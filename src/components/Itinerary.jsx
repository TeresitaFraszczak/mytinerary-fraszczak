...
export default function DetailCity({ name, price, duration, tags, photo, admin_id, admin_photo }) {
  ...
  return (
    <>
    <div className="flex flex-col items-center justify-center mt-5 px-15">
        <div className="w-[700px] h-[750px] flex flex-grow flex-col items-center justify-start bg-slate-100 mb-4">
            <p className=" flex items-center justify-center my-5 text-[2opx] font-bold m-4">{name}</p>
            <img className="h-[500px] mx-5" src={photo} alt="photo" />
           
            <div className="flex w-[650px] h-[120px] mt-6  items-center justify-between">
            ...
            <div className="flex w-[650px] h-[30px] items-center justify-between">
