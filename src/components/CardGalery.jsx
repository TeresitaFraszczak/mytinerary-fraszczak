...
export default function CardGalery({src,text,id}) {
  return (
    <div className="flex flex-col justify-between h-[200px] w-[330px] m-2 bg-cover bg-center rounded-lg text-white shadow-md shadow-white/5 hover:sepia" style={{backgroundImage:`url(${src})`}} >        
       <p id="shadows" className="text-[15px] font-bold p-2">{text}</p>
